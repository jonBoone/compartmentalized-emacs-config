;;; compartmentalized-completion-packages.el --- Completion packages  -*- lexical-binding: t; -*-
...
(provide 'compartmentalized-completion-packages)
;;; compartmentalized-completion-packages.el ends here
