;;; compartmentalized-defaults.el -*- lexical-binding: t; -*-
...
;; General Compartmentalized Emacs endorsed defaults
;;
...

;;; Window management
(defgroup compartmentalized-windows '()
  "Window related configuration for Compartmentalized Emacs."
  :tag "Compartmentalized Windows"
  :group 'compartmentalized)

(defcustom compartmentalized-windows-prefix-key "C-c w"
...
also enables undo functionality if the window layout changes."
  :group 'compartmentalized-windows
  :type 'string)
...
(define-prefix-command 'compartmentalized-windows-key-map)

(keymap-set 'compartmentalized-windows-key-map "u" 'winner-undo)
(keymap-set 'compartmentalized-windows-key-map "r" 'winner-redo)
(keymap-set 'compartmentalized-windows-key-map "n" 'windmove-down)
(keymap-set 'compartmentalized-windows-key-map "p" 'windmove-up)
(keymap-set 'compartmentalized-windows-key-map "b" 'windmove-left)
(keymap-set 'compartmentalized-windows-key-map "f" 'windmove-right)

(keymap-global-set compartmentalized-windows-prefix-key 'compartmentalized-windows-key-map)
...
(provide 'compartmentalized-defaults-config)
;;; compartmentalized-defaults-config.el ends here
