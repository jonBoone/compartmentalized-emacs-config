;;;; compartmentalized-lisp-config.el --- Lisp development configuration  -*- lexical-binding: t; -*-
...
(with-eval-after-load "clojure-mode"
  ...
  (defun compartmentalized-lisp-load-clojure-refactor ()
  ...
  (add-hook 'clojure-mode-hook #'compartmentalized-lisp-load-clojure-refactor)
...
(provide 'compartmentalized-lisp-config)
;;; compartmentalized-lisp-config.el ends here
